...
export class ShopComponent implements OnInit {
    ...
    onBrandSelected(brandId: number) {
        ...
        this.shopParams.pageNumber = 1; // reset the pageNumber back to '1' (initial value) so the products are displayed
    ...
    onSearch() {
        this.shopParams.search = this.searchTerm.nativeElement.value; // get the value from the 'input' 
        this.shopParams.pageNumber = 1;
        this.getProducts();
    }
